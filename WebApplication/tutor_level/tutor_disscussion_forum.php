...
<html lang="en">
  ...
  <div  class="sidebar">
    <ul>
      ...
      <li> <a href="tutor_module.php"> <span class="material-icons">  view_module</span></a> </li>
  ...
  <div class="modal" id="modal">
    ...
    <div class="modal-body">
      <?php
        echo "<form action='tutor_disscussion_forum.php?contentid=$content_id'  id = 'addcomment'  method ='POST'>";
        ?>
        ...
        <?php
          ...
          if ($request->num_rows == 0) {
              ...
              while ($row2 = $execute->fetch_assoc()) {
                  ...
                  $checkLike = "SELECT * FROM likes_table WHERE discussion_id = '$discussion_id' AND  tutor_id = '$userid'";
                  $executeCheck = $conn->query($checkLike);
          
                  $exist = $executeCheck->num_rows;
          
                  if ($exist > 0 ) {
                      echo "<a href='php_functionality/discussion_forum_likes_unlike.php?type=post&id=$discussion_id&tutor=$userid'> Unlike $likes </a>";
                  } else {
                      
                      echo "<a href='php_functionality/discussion_forum_likes.php?type=post&id=$discussion_id&tutor=$userid'> Like $likes </a>";
                  }
